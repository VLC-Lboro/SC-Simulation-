...
class RuntimeRegressionTests(unittest.TestCase):
    def test_supply_chain_simulation_exposes_oem_order_step(self):
        sim = SupplyChainSimulation(SimulationConfig(num_periods=5), scenario_name="forecast_sharing")
        self.assertTrue(hasattr(sim, "place_oem_order"))
        self.assertTrue(hasattr(sim, "_place_oem_order"))
        sim._place_oem_order()
        sim.run_simulation()
